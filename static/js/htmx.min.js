var htmx = function () {
    ...
    function A(e) {
        return e.matches("script") &&
            (e.type === "text/javascript" || e.type === "module" ||
                e.type === "");
    }
    function I(e) {
            ...
            const s = function (e) {
                ...
                if (t.handledFor.indexOf(l) < 0) {
                    ...
                    if (u.target && e.target) {
                        if (!d(ue(e.target), u.target)) return;
                    }
                    if (u.once) {
    ...
    function Rt(e) {
        ...
        if (e instanceof DocumentFragment) {
            for (const n of e.childNodes) Ot(n, t);
        } else Ot(e, t);
        return t;
    }
    function Ht(e) {
    ...
    function tn(e) {
        ...
        if (
            ...
            t.tagName === "image" || t.tagName === "reset" ||
            t.tagName === "file"
        ) return false;
    ...
    function Dn(o, i) {
        ...
        if (O(s, /HX-Retarget:/i)) {
            if (
                s.getResponseHeader("HX-Retarget") === "this"
            ) i.target = o;
